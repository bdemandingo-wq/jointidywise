...
begin
  insert into public.invoices (organization_id, customer_id, total_amount, subtotal, status, paid_at)
  values ('0ddb3567-4641-48c8-8ff7-4bf1b87681da','4a90460a-92a8-469e-bf9d-6fac63c7484b',1.00,1.00,'paid',now())
